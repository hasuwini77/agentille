...
- **agentille:agentille-design-reviewer** — for UI work; screenshots + WCAG 2.2 a11y audit (`accessibility` / `web-design-guidelines` skills) + visual critique (read-only on source)
